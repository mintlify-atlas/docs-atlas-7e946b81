...
| ID | Name | Type | Owner | C | I | A | Criticality |
|---|---|---|---|---|---|---|---|
| A001 | Customer Database | Information | CISO | 3 | 3 | 3 | Critical |
| A002 | Primary ERP Server | Hardware | CISO | 2 | 3 | 2 | Critical |
| A003 | Mobile App Source Code | Software | CISO | 3 | 2 | 1 | Critical |
| A004 | Management Offices | Infrastructure | CISO | 1 | 1 | 1 | Normal |
