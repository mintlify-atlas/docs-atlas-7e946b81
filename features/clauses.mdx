...
<Steps>
  ...
  <Step title="Set the implementation status">
    ...
    | Implemented | Fully conformant |
    | Not applicable | Requirement does not apply to your scope |
  </Step>
...
<Tip>
  Requirements marked **Not applicable** are excluded from the compliance percentage calculation for that clause. Use this status carefully — auditors will expect a documented justification for any exclusion.
</Tip>
