...
| `type` | `string` | Asset type (e.g. server, application) |
| `owner` | `string` | Asset owner |
| `c` | `number` | Confidentiality score 1–5 |
| `i` | `number` | Integrity score 1–5 |
| `d` | `number` | Availability score 1–5 |
...
| `assetName` | `string` | Display name of linked asset |
...
| `mitigationControl` | `string` | Applied control description |
| `residualLikelihood` | `number` | Residual likelihood 1–5 |
| `residualImpact` | `number` | Residual impact 1–5 |
| `residualRisk` | `number` | `residualLikelihood × residualImpact` (1–25) |
...
**Returns:** `string` — Tailwind utility class (e.g. `'text-red-500'`).
