...
<Steps>
  ...
  <Step title="Click Generate Report">
    Locate the **Generate Report** button on the Dashboard page and click it. ISOwl reads the current state of all controls, clauses, risks, and findings at that moment.
  </Step>
  <Step title="Download the PDF">
    The PDF is generated in your browser and downloaded automatically. The file is named with the current date for easy filing.
  </Step>
</Steps>
