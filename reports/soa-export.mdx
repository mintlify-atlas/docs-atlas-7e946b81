...
| Field | Description |
|---|---|
| Control ID | Annex A reference (e.g., A.5.1, A.8.24) |
| Control name | Short title from ISO/IEC 27002 |
| Domain | Organizational, People, Physical, or Technological |
| Status | Current evaluation state (e.g., Implemented, In Progress, Not Applicable) |
| Responsible person | Individual or team accountable for the control |
| Last review date | Date the control record was last updated |
